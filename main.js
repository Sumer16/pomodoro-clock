$(() => {
  ...
  function audioSelect(e){
    ...
    switch(e.target.id){
      case "forest": $audio.attr("src", "./audio/forest.mp3"); break;
      case "ocean": $audio.attr("src", "./audio/ocean.mp3"); break;
      case "rainy": $audio.attr("src", "./audio/rain.mp3"); break;
      case "peace": $audio.attr("src", "./audio/peace.mp3"); break;
      case "cafe": $audio.attr("src", "./audio/cafe.mp3"); break;
    }
  }
